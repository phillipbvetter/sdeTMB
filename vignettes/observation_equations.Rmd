---
title: "Observation equation transformations"
author: ""
date: ""
...
When the observation equations of a model is specified it is possible to apply functions to the left-hand side variable i.e.
...
The `construct_nll` method allows you to retrieve the `nll` object. The function takes arguments similar to those of `estimate`.
