...
construct_and_optimise = function(self, private, return.fit, return.nll) {
  ...
  #   message(nll)
  #   stop("Pre-compiled model parameters and the supplied do not match.
  #        You might need to recompile your model - if so, prepare for recompilation with $set_compile(TRUE) before running $estimate.")
  # }
